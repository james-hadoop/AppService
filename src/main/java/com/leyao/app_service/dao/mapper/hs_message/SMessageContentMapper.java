...
public interface SMessageContentMapper {
    @Delete({ "delete from s_message_content", "where s_message_content_id = #{sMessageContentId,jdbcType=BIGINT}" })
    int deleteByPrimaryKey(Long sMessageContentId);

    @Insert({ "insert into s_message_content (s_message_content_id, h_message_id, ",
            "s_message_content_str, create_ts, ", "update_ts)",
    ...
    @Select({ "select", "s_message_content_id, h_message_id, s_message_content_str, create_ts, update_ts",
            "from s_message_content", "where s_message_content_id = #{sMessageContentId,jdbcType=BIGINT}" })
    @Results({
    ...
    @Update({ "update s_message_content", "set h_message_id = #{hMessageId,jdbcType=BIGINT},",
