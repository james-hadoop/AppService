...
public class HsUserController {
     ...
     * 
     * @apiSuccessExample {json} Success-Response: { "responseResult":
     *                    "SUCCESS", "responseResultMsg": "Reset success" }
     * 
     * @apiSuccessExample {json} Error-Response: { "responseResult": "ERROR",
     *                    "responseResultMsg": "Login fail" }
     */
    ...
    public ResponseContent editTUserSummary(@RequestBody TUserSummary tUserSummary) {
        logger.info("/v1/service/user/editTUserSummary() called: hUserPhoneNr={},sUserEmailStr={},sUserGenderDesc={},sUserNameStr={}", tUserSummary.gethUserPhoneNr(), tUserSummary.getsUserEmailStr(),
