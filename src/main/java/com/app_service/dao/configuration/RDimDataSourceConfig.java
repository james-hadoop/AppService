...
public class RDimDataSourceConfig {
    ...
    @ConfigurationProperties("datasource.r_dim")
    public DataSource masterDataSource() {
        DataSource dataSource=DataSourceBuilder.create().build();
        return dataSource;
    }

    @Bean(name = "rDimSqlSessionFactory")
    public SqlSessionFactory sqlSessionFactory(@Qualifier("rDimDataSource") DataSource dataSource) throws Exception {
