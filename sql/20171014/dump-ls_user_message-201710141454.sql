...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='用户与消息关系表，乐谣创建消息发送对象时记录';
...
INSERT INTO `l_user_message` VALUES (1,1,1,'2017-09-15 14:55:00','2017-09-15 14:55:00');
...
CREATE TABLE `s_user_message_active` (
  ...
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='用户与消息关系激活状态记录表，乐谣创建消息发送对象时记录，写入默认值';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_message_active` VALUES (1,1,0,'2017-09-15 14:55:00','2017-09-15 14:55:00');
