...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='用户注册记录表，用户注册返回验证码，验证成功后生成用户id';
...
INSERT INTO `h_user` VALUES (1,13333333333,'1999-12-31 16:00:00','1999-12-31 16:00:00'),(5,15821615886,'2017-10-12 02:35:54','2017-10-12 02:35:54');
...
CREATE TABLE `s_user_active` (
  ...
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='用户激活状态记录表，用户注册返回验证码，验证成功后记录，写入默认值';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_active` VALUES (1,1,0,'1999-12-31 16:00:00','1999-12-31 16:00:00'),(5,5,0,'2017-10-12 02:35:54','2017-10-13 09:28:11');
...
CREATE TABLE `s_user_email` (
  ...
  KEY `idx_h_user_id` (`h_user_id`),
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='用户头像地址记录表，1.用户注册成功后跳转至信息填写页面记录。2.用户个人页面修改信息记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_email` VALUES (1,1,'zhangsan@leyao.com','1999-12-31 16:00:00','1999-12-31 16:00:00'),(5,5,'lisi@leyao.com','1999-12-31 16:00:00','1999-12-31 16:00:00');
...
CREATE TABLE `s_user_feedback` (
  ...
  KEY `idx_h_user_id` (`h_user_id`),
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='用户反馈信息记录表，个人页面中，我的意见模块记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_feedback` VALUES (1,1,'Leyao app is great!!!','1999-12-31 16:00:00','2017-10-10 13:33:40'),(2,1,'Hi Leyao!!!','1999-12-31 16:00:00','2017-10-10 15:01:04'),(3,1,'Hi Leyao2!!!','1999-12-31 16:00:00','1999-12-31 16:00:00');
...
CREATE TABLE `s_user_gender` (
  ...
  KEY `idx_h_user_id` (`h_user_id`),
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='用户性别记录表，1.用户注册成功后跳转至信息填写页面记录。2.用户个人页面修改信息记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_gender` VALUES (1,1,0,'1999-12-31 16:00:00','1999-12-31 16:00:00'),(5,0,1,'1999-12-31 16:00:00','1999-12-31 16:00:00');
...
CREATE TABLE `s_user_name` (
  ...
  KEY `idx_h_user_id` (`h_user_id`),
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='用户姓名记录表，1.用户注册成功后跳转至信息填写页面记录。2.用户个人页面修改信息记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_name` VALUES (1,1,'张三','1999-12-31 16:00:00','1999-12-31 16:00:00'),(5,5,'李四','1999-12-31 16:00:00','2017-10-13 09:27:58');
...
CREATE TABLE `s_user_password` (
  ...
  KEY `idx_h_user_id` (`h_user_id`),
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COMMENT='用户密码记录表，1.用户注册返回验证码，验证成功后记录。2.用户个人页面修改信息记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_password` VALUES (1,1,'5f4dcc3b5aa765d61d8327deb882cf99','1999-12-31 16:00:00','2017-09-17 11:46:26'),(14,5,'7c6a180b36896a0a8c02787eeafb0e4c','2017-10-12 02:35:54','2017-10-12 02:40:25');
...
INSERT INTO `s_user_profile` VALUES (1,1,'static/portrait/13333333333.jpg','1999-12-31 16:00:00','1999-12-31 16:00:00'),(5,5,'static/portrait/15821615886.jpg','1999-12-31 16:00:00','1999-12-31 16:00:00');
...
INSERT INTO `t_user_page` VALUES (1,13333333333,0,'未知','张三','static/portrait/13333333333.jpg','zhangsan@leyao.com',0,'1999-12-31 16:00:00','2017-10-13 09:31:07'),(5,15821615886,1,'男','李四','static/portrait/13333333334.jpg','lisi@leyao.com',0,'2017-10-12 02:35:54','2017-10-13 09:31:07');
...
-- Dump completed on 2017-10-14 14:54:51
