...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='用户与事件关系表，加载页面时，创建用户对应读取到的事件标题链接时记录';
...
INSERT INTO `l_user_event` VALUES (1,1,1,'2017-09-15 14:55:00','2017-09-15 14:55:00');
...
CREATE TABLE `s_user_event_active` (
  ...
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='用户与事件关系激活状态记录表，加载页面时，创建用户对应读取到的事件标题链接时记录，写入默认值';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_event_active` VALUES (1,1,0,'2017-09-15 14:55:00','2017-09-15 14:55:00');
...
CREATE TABLE `s_user_event_like` (
  ...
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='用户与事件关系用户点赞事件记录表，用户点赞后记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_event_like` VALUES (1,1,1,'2017-09-15 14:55:00','2017-09-17 12:24:40');
...
INSERT INTO `s_user_event_read` VALUES (1,1,'great','2017-09-15 14:55:00','2017-09-15 14:55:00');
/*!40000 ALTER TABLE `s_user_event_read` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'ls_user_event'
--
...
-- Dump completed on 2017-10-14 14:54:52
