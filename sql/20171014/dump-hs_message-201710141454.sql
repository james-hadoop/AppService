...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='乐谣消息推送表，乐谣创建消息时记录';
...
INSERT INTO `hs_message` VALUES (1,'2017-09-15 14:55:00','2017-09-15 14:55:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='消息激活状态记录表，乐谣创建消息时记录，写入默认值';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_message_active` VALUES (1,1,0,'2017-09-15 14:55:00','2017-09-15 14:55:00');
...
CREATE TABLE `s_message_category` (
  ...
  KEY `idx_h_message_id` (`h_message_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='乐谣创建消息时记录，存放消息种类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_message_category` VALUES (1,1,1,'2017-09-15 14:55:00','2017-09-15 14:55:00');
...
CREATE TABLE `s_message_content` (
  ...
  PRIMARY KEY (`s_message_content_id`),
  KEY `idx_h_message_id` (`h_message_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='消息内容记录表，乐谣创建消息时记录，存放消息内容';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_message_content` VALUES (1,1,'first message','2017-09-15 14:55:00','2017-09-15 14:55:00');
