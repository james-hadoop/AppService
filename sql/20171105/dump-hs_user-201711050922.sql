...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='用户注册记录表，用户注册返回验证码，验证成功后生成用户id';
...
INSERT INTO `h_user` VALUES (1,13333333333,'1999-12-31 16:00:00','2017-11-01 15:59:24'),(10,13333333332,'2017-10-22 05:31:48','2017-10-28 00:59:32');
...
CREATE TABLE `s_user_active` (
  ...
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='用户激活状态记录表，用户注册返回验证码，验证成功后记录，写入默认值';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_active` VALUES (1,1,0,'1999-12-31 16:00:00','2017-11-01 15:59:24'),(10,10,0,'2017-10-22 05:31:48','2017-10-28 00:59:32');
...
CREATE TABLE `s_user_email` (
  ...
  KEY `idx_h_user_id` (`h_user_id`),
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='用户头像地址记录表，1.用户注册成功后跳转至信息填写页面记录。2.用户个人页面修改信息记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_email` VALUES (1,1,'james@leyao.com','1999-12-31 16:00:00','2017-11-01 15:59:24'),(10,10,'lisi@cc.com','2017-10-22 05:31:48','2017-10-22 05:31:48');
...
CREATE TABLE `s_user_feedback` (
  ...
  KEY `idx_h_user_id` (`h_user_id`),
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='用户反馈信息记录表，个人页面中，我的意见模块记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_feedback` VALUES (1,1,'Leyao app is great!!!','1999-12-31 16:00:00','2017-10-10 13:33:40'),(2,1,'Hi Leyao!!!','1999-12-31 16:00:00','2017-10-10 15:01:04'),(3,1,'Hi Leyao2!!!','1999-12-31 16:00:00','1999-12-31 16:00:00'),(4,1,'Hi Leyao3!!!','1999-12-31 16:00:00','1999-12-31 16:00:00');
...
CREATE TABLE `s_user_gender` (
  ...
  KEY `idx_h_user_id` (`h_user_id`),
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='用户性别记录表，1.用户注册成功后跳转至信息填写页面记录。2.用户个人页面修改信息记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_gender` VALUES (1,1,0,'1999-12-31 16:00:00','2017-11-01 15:59:24'),(10,10,1,'2017-10-22 05:31:48','2017-10-22 05:31:48');
...
CREATE TABLE `s_user_name` (
  ...
  KEY `idx_h_user_id` (`h_user_id`),
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='用户姓名记录表，1.用户注册成功后跳转至信息填写页面记录。2.用户个人页面修改信息记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_name` VALUES (1,1,'James33','1999-12-31 16:00:00','2017-11-01 15:59:24'),(10,10,'李四','2017-10-22 05:31:48','2017-10-22 05:31:48');
...
CREATE TABLE `s_user_password` (
  ...
  KEY `idx_h_user_id` (`h_user_id`),
  KEY `idx_create_ts` (`create_ts`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COMMENT='用户密码记录表，1.用户注册返回验证码，验证成功后记录。2.用户个人页面修改信息记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_password` VALUES (1,1,'696d29e0940a4957748fe3fc9efd22a3','1999-12-31 16:00:00','2017-11-01 15:59:24'),(19,10,'74be16979710d4c4e7c6647856088456','2017-10-22 05:31:48','2017-10-28 00:59:32');
...
INSERT INTO `s_user_profile` VALUES (1,1,'sUserProfileUrl','1999-12-31 16:00:00','2017-11-01 15:59:24'),(10,10,'static/portrait/13333333332.jpg','2017-10-22 05:31:48','2017-10-22 05:31:48');
...
INSERT INTO `t_user_page` VALUES (1,13333333333,0,'未知','James33','sUserProfileUrl','james@leyao.com',0,'1999-12-31 16:00:00','2017-11-01 15:59:24'),(10,13333333332,1,'男','李四','static/portrait/13333333332.jpg','lisi@cc.com',0,'2017-10-22 05:31:48','2017-10-28 00:59:32');
/*!40000 ALTER TABLE `t_user_page` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'hs_user'
--
